...
**Applications**
- **Realify** — Full-stack real estate platform. Python/FastAPI backend, React frontend, AWS infrastructure (DynamoDB, S3, Terraform).
- **Eldritch Wrangler** — iOS horror creature-capture game. Swift, SwiftUI, SpriteKit, and Metal. MVVM architecture.
